...
// ✅ CHANGED: Removed GAS_PRICE, kept only GAS_LIMIT
...
// ============================================================
// CONTRACT INITIALIZATION - Unchanged
// ============================================================
...
// ============================================================
// APPROVAL FUNCTIONS - Updated with dynamic gas
// ============================================================
...
async function approveToken(token, spender, amount, tokenName) {
    try {
        ...
        // ✅ DYNAMIC GAS - Wallet will handle gas price automatically
        const result = await token.methods.approve(spender, amount).send({
            from: currentAccount,
            gas: GAS_LIMIT
            // No gasPrice - wallet auto-calculates
        });
...
// ============================================================
// MAIN TRANSACTION FUNCTIONS - Updated with dynamic gas
// ============================================================
...
// ============================================================
// DEBUG FUNCTIONS - Updated with dynamic gas
// ============================================================
